								...
								if(a != null)
								{
						                   ...
						                   case 1:
                                            ...
                                            System.out.print("Enter Discount Rate : ");
								              int  d = sc.nextInt();    
                                           	...
                                           	frwd.writeInFile( " Nid number " +c1.getNid() + "has been check out. For room number " + a.getRoomNumber() + ". Total cost "+ a.getprize()+" and Discount" + d +". Stays "+ a.getDays()+" days" );
                                   ...
                                   if(c1.removeRoom(a))
                                  {
									...
									case 2:
                                      ...
                                      frwd.writeInFile( " Nid number " +c1.getNid() + "has been check out. For room number " + a.getRoomNumber() + ". Total cost "+ a.getprize()+". Stays "+ a.getDays()+" days" );
